fn main() {
    ...
    */
    ...
    let char_4_bytes_unicode: char = 'a';

    let tupled: (i8, String, bool) = (1, String::from("This is a string"), false);
    let arr: [i32; 10] = [1; 10];
    ...
    println!("{:?}", tupled); // when the default formatter doesn't work | We'll learn a better way later on.!
    println!("{}", tupled.0);
    println!("{}", tupled.1);
    println!("{}", tupled.2);
    println!("{:?}", arr);
